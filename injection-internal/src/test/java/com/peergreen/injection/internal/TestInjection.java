...
import com.peergreen.injection.internal.BasicInjectionService;
...
public class TestInjection {
   ...
   private Map<String, Object> jndi;
    ...
    public void getInjection() throws InjectException {
        ...
        BasicInjectionService injectionService = new BasicInjectionService();

        injectionService.bindProcessor(new WrappedProcessor(new MyInjectionProcessor()));

        this.annotatedClass  = injectionService.getInjection(artifact, classMetadata);
